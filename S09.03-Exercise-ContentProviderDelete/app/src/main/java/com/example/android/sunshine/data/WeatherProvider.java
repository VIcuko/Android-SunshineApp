...
//  TODO (1) Implement the delete method of the ContentProvider - Done
    /**
...
//      TODO (2) Only implement the functionality, given the proper URI, to delete ALL rows in the weather table - Done
        int deletedRows;
        ...
        if (deletedRows != 0) {
//      TODO (3) Return the number of rows deleted - Done
            getContext().getContentResolver().notifyChange(uri,null);
        }
        return deletedRows;
    }
