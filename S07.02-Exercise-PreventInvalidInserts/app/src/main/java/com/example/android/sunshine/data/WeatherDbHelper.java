...
//  TODO (2) Increment the database version after altering the behavior of the table - Done
    /*
...
//              TODO (1) Append NOT NULL to each column's type declaration except for the _ID - Done
                /*
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int oldVersion, int newVersion) {
        // TODO (3) Within onUpgrade, drop the weather table if it exists - Done
        final String SQL_DELETE_ENTRIES =
                "DROP TABLE IF EXISTS " + WeatherEntry.TABLE_NAME;
        sqLiteDatabase.execSQL(SQL_DELETE_ENTRIES);
        // TODO (4) call onCreate and pass in the SQLiteDatabase (passed in to onUpgrade) - Done
