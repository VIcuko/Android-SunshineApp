...
//      TODO (7) Replace the single TextView with Views to display all of the weather info - Done
...
//      TODO (4) Replace the weatherSummary TextView with individual weather detail TextViews - Done
        final TextView dateView;
        final TextView descriptionView;
        final TextView highTempView;
        final TextView lowTempView;

//      TODO (5) Add an ImageView for the weather icon - Done
        final ImageView iconView;

        ForecastAdapterViewHolder(View view) {
            super(view);

//          TODO (6) Get references to all new views and delete this line - Done
